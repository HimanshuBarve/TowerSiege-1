...
function setup() {
  ...
  polygon = new Polygon(50,150,50,50) //polygon here 

  slingShot = new SlingShot(polygon.body,{x:100,y:200})// Error 
...
//layer 2
 block24 = new Block(640,150,30,40);
 block25 = new Block(670,150,30,40);
 block26 = new Block(700,150,30,40);
 block27 = new Block(730,150,30,40);
 block28 = new Block(760,150,30,40);
//layer 3
